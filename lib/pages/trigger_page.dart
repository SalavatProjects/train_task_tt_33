                ...
                child: Opacity(
                  ...
                  child: CupertinoButton(
                      ...
                      onPressed: _isNameFilledAndTriggerAdded ?
                          () async {
                            context.read<TriggerBloc>().updateName(_nameTextEditingController.text);
                            context.read<TriggerBloc>().addSubjects(_triggerSubjectsList);
                            if (_commentTextEditingController.text.isNotEmpty) {
                              context.read<TriggerBloc>().updateComment(_commentTextEditingController.text);
                            }
