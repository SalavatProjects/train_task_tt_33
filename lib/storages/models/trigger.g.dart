...
void _triggerSerialize(
  ...
  writer.writeStringList(offsets[2], object.subjects);
}
...
Trigger _triggerDeserialize(
  ...
  object.subjects = reader.readStringList(offsets[2]);
  return object;
}
...
extension TriggerQueryFilter
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> commentIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> commentIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'subjects',
      ));
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'subjects',
      ));
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'subjects',
        0,
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'subjects',
        0,
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Trigger, Trigger, QAfterFilterCondition> subjectsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TriggerQueryWhereDistinct
  ...
  QueryBuilder<Trigger, Trigger, QDistinct> distinctBySubjects() {
    return QueryBuilder.apply(this, (query) {
...
extension TriggerQueryProperty
  ...
  QueryBuilder<Trigger, List<String>?, QQueryOperations> subjectsProperty() {
    return QueryBuilder.apply(this, (query) {
